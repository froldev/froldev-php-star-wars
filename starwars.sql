...
INSERT INTO `beast` (`id`, `name`) VALUES
(1, "Humain"),
(2, "Droïde"),
(3, "Wookiee"),
(4, "Zabrak"),
...
--
ALTER TABLE `characters`
  ADD CONSTRAINT `characters_ibfk_1` FOREIGN KEY (`id_movie`) REFERENCES `movie` (`id`),
  ADD CONSTRAINT `characters_ibfk_2` FOREIGN KEY (`id_beast`) REFERENCES `beast` (`id`),
  ADD CONSTRAINT `characters_ibfk_3` FOREIGN KEY (`id_faction`) REFERENCES `faction` (`id`),
  ;
